...
RLC <- rownames(countDF)[which(countDF==1)]
RLR <- rownames(countDF)[which(countDF==-1)]
RL_DIET_TOTAL <- c(RLC, RLR)

saveRDS(RLC, file="RLC.Rds")
saveRDS(RLR, file="RLR.Rds")
saveRDS(RL_DIET_TOTAL, file="RL_DIET_TOTAL.Rds")
```
