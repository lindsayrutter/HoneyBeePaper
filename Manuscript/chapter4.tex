...
\subsection{Main effect results}

We observed a substantially larger number of DEGs in our diet main effect (n = 1914) than in our virus main effect (n = 43) (Table \ref{tbl:mainEffectDEGs}A and B). In the diet factor, there were more Castanea DEGs (n = 1033) than Rockrose DEGs (n = 881). In the virus factor, there were more virus-exposed DEGs (n = 38) than control DEGs (n = 5). While these reported DEGs numbers are from the DESeq2 package, we saw similar trends for the edgeR and limma package results (Table \ref{tbl:mainEffectDEGs}A and B). Pathway 
