...
jpeg(fileName)
tgD = intersect(gD2, tD)
draw.pairwise.venn(area1=intgD, area2=inttD, cross.area = length(tgD), category=c("g-DESeq2", "t-DESeq2"))
invisible(dev.off())
...
jpeg(fileName)
tgE = intersect(gE2, tE)
draw.pairwise.venn(area1=intgE, area2=inttE, cross.area = length(tgE), category=c("g-EdgeR", "t-EdgeR"))
invisible(dev.off())
...
jpeg(fileName)
tgEB = intersect(gEB2, tEB)
draw.pairwise.venn(area1=intgEB, area2=inttEB, cross.area = length(tgEB), category=c("g-EdgeR-btwn", "t-EdgeR-btwn"))
invisible(dev.off())
