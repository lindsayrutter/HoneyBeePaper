functionRT <- function(data, type, PVal){
  ...
  print({
    ...
    ggplot(plotVirus, aes(x=Group, y=R2_Mort)) + geom_boxplot(fill="palegreen2") + geom_text(data = labelDF, aes(x = plot.labels, y = V1, label = labels)) + ylab("R2 with Mort titers") + theme_gray()
  })
  dev.off()  
  ...
  print({
    ...
    ggplot(plotTolerance, aes(x=Group, y=R2_Mort)) + geom_boxplot(fill="palegreen2") + geom_text(data = labelDF, aes(x = plot.labels, y = V1, label = labels)) + ylab("R2 with Mort titers") + theme_gray()
  })
  dev.off()  
  ...
  print({
    ...
    ggplot(plotResistance, aes(x=Group, y=R2_Mort)) + geom_boxplot(fill="palegreen2") + geom_text(data = labelDF, aes(x = plot.labels, y = V1, label = labels)) + ylab("R2 with Mort titers") + theme_gray()
  })
  dev.off()  
return(PVal)
  }
